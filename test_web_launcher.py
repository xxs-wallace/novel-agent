...
def test_root_web_launcher_bootstraps_venv_and_starts_web_entrypoint() -> None:
    launcher = Path("novel-agent-web")
    ...
    assert '-m cli.novel_agent_web --repo-root "$REPO_ROOT" "$@"' in script
