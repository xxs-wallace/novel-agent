...
def build_character_evidence_prompt(prompt_input: dict[str, Any]) -> tuple[str, str]:
    system_prompt = (
        ...
        "9. 严禁把动词、物品、抽象名词、场景词当人物名，如“张开/高跟鞋/上下打量/学院”。\n"
        "10. 每个人物必须返回 source_doc_ids 和 source_title_indexes，用于后续按故事顺序归纳；只需轻量来源引用，不要 offset。\n"
        "11. 不要输出 mention_offsets、speaking_offsets、原文连续子串、逐 doc_id 人物列表或 document_character_mentions。\n"
